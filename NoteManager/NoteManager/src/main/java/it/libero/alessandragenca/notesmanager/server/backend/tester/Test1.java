...
public class Test1 {
	...
	public static void main(String[] args) throws InvalidKeyException {
		...
		try {
			...
			nr.add(new Note("Nota1", "Questo � il testo della nota 1",myDate));
		...
		try {
			...
			nr.add(new Note("Nota2", "Questo � il testo della nota 2",myDate));
			System.out.println("OK");
		...
		try {
			...
			nr.add(new Note("Nota3", "Questo � il testo della nota 3",data1));
			System.out.println("OK");
			System.out.println("OK");
		} catch (InvalidKeyException e) {
			System.out.println("ERR: " + e.getMessage());
		...
		try {
			...
			nr.add(new Note("Nota5", "Questo � il testo della nota 5",myDate));
			System.out.println("OK");
		} catch (InvalidKeyException e) {
			System.out.println("ERR: " + e.getMessage());
		}
		...
		try {
			System.out.println("add-03");
			nr.add(new Note("Nota3", "Questo � il testo della nota 3",myDate));
			System.out.println("OK");
		} catch (InvalidKeyException e) {
			System.out.println("ERR: " + e.getMessage());
		}
