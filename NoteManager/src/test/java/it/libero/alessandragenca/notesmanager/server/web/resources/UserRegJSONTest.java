...
public class UserRegJSONTest {
    ...
    public UserRegJSON userRegJson= new UserRegJSON();
    public  MemoryRealm realm = new MemoryRealm() ;
    ...
    public void test() {
        ...
        assertTrue("L'utente "+utente1.getIdentifier()+ String.copyValueOf(utente1.getSecret())+" esiste, le credenziali sono corrette e dovrebbe autenticarsi!", gson.fromJson(userRegJson.checkUser(gson.toJson(utente1.getIdentifier()+";"+ String.copyValueOf(utente1.getSecret()),String.class)), Boolean.class));
