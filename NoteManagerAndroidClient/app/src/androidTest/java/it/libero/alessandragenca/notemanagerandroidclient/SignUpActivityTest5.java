...
public class SignUpActivityTest5 {

    //SignUp utente già esistente

    @Rule
    public ActivityTestRule<LogInActivity> mActivityTestRule = new ActivityTestRule<>(LogInActivity.class);

    @Test
    public void signUpActivityTest5() {
...
*/
        ...
        onView(withId(R.id.textView2)).check(matches(withText("Username gia' utilizzato")));

  /*      ViewInteraction textView = onView(
                allOf(withId(R.id.textView2), withText("Username gia' utilizzato"),
                        childAtPosition(
                                allOf(withId(R.id.activity_main),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                ...
                                5),
                        isDisplayed()));
        textView.check(matches(withText("Username gia' utilizzato")));
*/
    }
