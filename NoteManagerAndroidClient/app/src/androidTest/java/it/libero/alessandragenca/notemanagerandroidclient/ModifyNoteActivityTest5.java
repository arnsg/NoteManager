...
public class ModifyNoteActivityTest5 {

    //nota non esistente con title e testo inseriti

    @Rule
    public ActivityTestRule<LogInActivity> mActivityTestRule = new ActivityTestRule<>(LogInActivity.class);

    @Test
    public void modifyNoteActivityTest5() {
        ...
        /*ViewInteraction textView = onView(
                allOf(withId(R.id.note), withText("{\"detailMessage\":\"Nota non presente nel registro\",\"stackTrace\":[],\"suppressedExceptions\":[]}"),
                        childAtPosition(
                                allOf(withId(R.id.activity_put_note),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                ...
                                4),
                        isDisplayed()));*/
        onView(withId(R.id.note)).check(matches(withText("{\"detailMessage\":\"Nota non presente nel registro\",\"stackTrace\":[],\"suppressedExceptions\":[]}")));
